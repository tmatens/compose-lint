...
| `DOCKERHUB_READ_TOKEN`                     | @tmatens              | Repo Actions secret                                               | Public Repo Read-only PAT for the scan jobs; any Docker Hub account that can pull the public image can mint a replacement.                            |
