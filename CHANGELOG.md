...
- Fixed file matching in `.pre-commit-hooks.yaml` that was incorrectly including
  `.compose-lint.yml` if present in the the commits. This generated errors
  meaning pre-commit will always fails (issue #465). **Note** this now only
...
[Unreleased]: https://github.com/tmatens/compose-lint/compare/v0.15.1...HEAD
